package hei.school.test.endpoint;

import static hei.school.test.concurrency.ThreadRenamer.renameFrontalThread;
import static hei.school.test.concurrency.ThreadRenamer.renameThread;
